...
async def main():
    ...
    try:
        ...
        pdu_list_name = await first_to_complete_rec(check_if_altuscn(args.ip), check_if_aten(args.ip), check_if_eaton(args.ip), check_if_raritan(args.ip))
